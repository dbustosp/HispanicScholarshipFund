...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field keydates on 'Applicant'
        db.create_table(u'textapp_applicant_keydates', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('applicant', models.ForeignKey(orm[u'textapp.applicant'], null=False)),
            ('keydate', models.ForeignKey(orm[u'textapp.keydate'], null=False))
        ))
        db.create_unique(u'textapp_applicant_keydates', ['applicant_id', 'keydate_id'])


    def backwards(self, orm):
        # Removing M2M table for field keydates on 'Applicant'
        db.delete_table('textapp_applicant_keydates')
