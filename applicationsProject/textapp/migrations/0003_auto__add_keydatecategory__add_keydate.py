...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Keydatecategory'
        db.create_table(u'textapp_keydatecategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kind', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'textapp', ['Keydatecategory'])

        # Adding model 'Keydate'
        db.create_table(u'textapp_keydate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'textapp', ['Keydate'])


    def backwards(self, orm):
        # Deleting model 'Keydatecategory'
        db.delete_table(u'textapp_keydatecategory')

        # Deleting model 'Keydate'
        db.delete_table(u'textapp_keydate')
